        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          <div class="flex flex-col md:flex-row -mx-4">
            <div class="md:flex-1 px-4">
              <div>
                <div class="h-80 md:h-80 rounded-lg bg-gray-100 mb-4">
                  <div class="h-[320px] md:h-[320px] lg:h-[320px] rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
                    <img
            ...
            <div class="md:flex-1 px-4">
              <h2 class="mb-2 leading-tight tracking-tight font-bold text-2xl md:text-3xl text-base-100">
                {product.name}
              </h2>
              ...
              <div class="flex items-center space-x-4 my-4">
                <div>
                  <div class="rounded-lg bg-gray-100 flex py-2 px-3 ">
                    ...
                    <span class="font-bold text-base-200 text-3xl">
                      {product.price}
                    </span>
                  </div>
                </div>
